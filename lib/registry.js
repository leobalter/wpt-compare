...
CustomElementRegistry.prototype.define = function define(tagName, constructor) {
...
CustomElementRegistry.prototype.get = function get(tagName) {
    var _a;
    return (_a = _definitionsByTag.get(tagName)) === null || _a === void 0 ? void 0 : _a.UserCtor;
};
...
// function getLWCPivot(tagName, constructor) {
//     tagName = tagName.toLowerCase();
//     let PivotCtor = _pivotCtorByTag.get(tagName);
//     if (!PivotCtor) {
//         const definition = getDefinitionForConstructor(constructor);
